...
[cisco.dcnm.dcnm_sgrp](https://github.com/CiscoDevNet/ansible-dcnm/blob/main/docs/cisco.dcnm.dcnm_sgrp_module.rst)|DCNM Ansible Module for managing Security Groups.
