...
class TestDcnmVrfModule12(TestDcnmModule):
    ...
    def test_dcnm_vrf_12_blank_fabric(self):
    ...
    def test_dcnm_vrf_12_merged_lite_redeploy_interface_without_extensions(self):
    ...
    def test_dcnm_vrf_12_check_mode(self):
        playbook = self.test_data.get("playbook_config")
        set_module_args(
            dict(
    ...
    def test_dcnm_vrf_12_merged_new(self):
        playbook = self.test_data.get("playbook_config")
        set_module_args(dict(state="merged", fabric="test_fabric", config=playbook))
        result = self.execute_module(changed=True, failed=False)
    ...
    def test_dcnm_vrf_12_merged_lite_new_interface_with_extensions(self):
    ...
    def test_dcnm_vrf_12_merged_duplicate(self):
        playbook = self.test_data.get("playbook_config")
        set_module_args(dict(state="merged", fabric="test_fabric", config=playbook))
        result = self.execute_module(changed=False, failed=False)
        self.assertFalse(result.get("diff"))

    def test_dcnm_vrf_12_merged_lite_duplicate(self):
    ...
    def test_dcnm_vrf_12_merged_with_incorrect_vrfid(self):
    ...
    def test_dcnm_vrf_12_merged_lite_invalidrole(self):
    ...
    def test_dcnm_vrf_12_merged_with_update(self):
    ...
    def test_dcnm_vrf_12_merged_lite_update_interface_with_extensions(self):
    ...
    def test_dcnm_vrf_12_merged_lite_update_interface_without_extensions(self):
    ...
    def test_dcnm_vrf_12_merged_with_update_vlan(self):
    ...
    def test_dcnm_vrf_12_error1(self):
        playbook = self.test_data.get("playbook_config")
        set_module_args(dict(state="merged", fabric="test_fabric", config=playbook))
        result = self.execute_module(changed=False, failed=True)
    ...
    def test_dcnm_vrf_12_error2(self):
        playbook = self.test_data.get("playbook_config")
        set_module_args(dict(state="merged", fabric="test_fabric", config=playbook))
        result = self.execute_module(changed=False, failed=True)
        self.assertIn(
    ...
    def test_dcnm_vrf_12_error3(self):
        playbook = self.test_data.get("playbook_config")
        set_module_args(dict(state="merged", fabric="test_fabric", config=playbook))
        result = self.execute_module(changed=False, failed=False)
        self.assertEqual(result["response"][2]["DATA"], "No switches PENDING for deployment")

    def test_dcnm_vrf_12_replace_with_changes(self):
    ...
    def test_dcnm_vrf_12_replace_with_no_atch(self):
    ...
    def test_dcnm_vrf_12_replace_lite_without_changes(self):
        playbook = self.test_data.get("playbook_vrf_lite_config")
        set_module_args(
            dict(
                state="replaced",
    ...
    def test_dcnm_vrf_12_lite_override_with_additions_interface_with_extensions(self):
    ...
    def test_dcnm_vrf_12_override_with_deletions(self):
    ...
    def test_dcnm_vrf_12_override_without_changes(self):
        playbook = self.test_data.get("playbook_config")
    ...
    def test_dcnm_vrf_12_override_no_changes_lite(self):
        playbook = self.test_data.get("playbook_vrf_lite_config")
        set_module_args(
            dict(
                state="overridden",
    ...
    def test_dcnm_vrf_12_delete_std(self):
        playbook = self.test_data.get("playbook_config")
    ...
    def test_dcnm_vrf_12_query(self):
        playbook = self.test_data.get("playbook_config")
    ...
    def test_dcnm_vrf_12_validation_no_config(self):
        """
        # Summary
