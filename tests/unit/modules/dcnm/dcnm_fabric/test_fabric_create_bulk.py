...
def test_fabric_create_bulk_00030(monkeypatch, fabric_create_bulk) -> None:
    ...
    Summary
    Verify behavior when user attempts to create a fabric and no
...
def test_fabric_create_bulk_00031(monkeypatch, fabric_create_bulk) -> None:
    ...
    Setup
    -  FabricDetails().refresh() is set to indicate that fabric f1 exists on the controller
...
def test_fabric_create_bulk_00032(monkeypatch, fabric_create_bulk) -> None:
    ...
    Setup
    -  FabricDetails().refresh() is set to indicate that no fabrics exist on the controller
