...
def test_dcnm_networkv2_00004(
    ...
    if tc_id == 1:
        ...
        assert networkv2.diff_input_format[0]["attach"][0]["deploy"] is True
    elif tc_id == 2:
        assert networkv2.diff_input_format[0]["attach"] == []
...
@pytest.mark.parametrize(
    ...
    [(1, "networkv2_cfg_00001", "networkv2_have_00001",
     "networkv2_want", "networkv2_net_objects_00002", "networkv2_net_attach_objects_00001"),
     (2, "networkv2_cfg_00001", "networkv2_have_00001",
     "networkv2_want", "networkv2_net_objects_00001", "networkv2_net_attach_objects_00001")],
)
...
@pytest.mark.parametrize(
    ...
    [(1, "networkv2_cfg_00001", "networkv2_have_00001", "networkv2_want",
     "networkv2_have_attach_00001", "networkv2_want_attach_00001"),
     (2, "networkv2_cfg_00001", "networkv2_have_00001", "networkv2_want",
     "networkv2_have_attach_00001", "networkv2_want_attach_00001")],
)
...
@pytest.mark.parametrize(
    ...
    [(1, "networkv2_cfg_00001", "networkv2_have_00001", "networkv2_want",
     "networkv2_have_attach_00001", "networkv2_want_attach_00001"),
     (2, "networkv2_cfg_00001", "networkv2_have_00001", "networkv2_want",
     "networkv2_have_attach_00001", "networkv2_want_attach_00002"),
     (3, "networkv2_cfg_00001", "networkv2_have_00001", "networkv2_want",
     "networkv2_have_attach_00001", "networkv2_want_attach_00003"),
     (4, "networkv2_cfg_00001", "networkv2_have_00001", "networkv2_want",
     "networkv2_have_attach_00001", "networkv2_want_attach_00001")],
)
