...
from .utils import (MockAnsibleModule, does_not_raise,
                    issu_details_by_ip_address_fixture, params,
                    responses_ep_issu)
...
def test_switch_issu_details_by_ip_address_00100(issu_details_by_ip_address) -> None:
    """
    ### Classes and Methods
...
def test_switch_issu_details_by_ip_address_00110(issu_details_by_ip_address) -> None:
    """
    ### Classes and Methods
    -   ``SwitchIssuDetailsByIpAddress``
            - ``refresh``
...
def test_switch_issu_details_by_ip_address_00120(issu_details_by_ip_address) -> None:
    """
    ### Classes and Methods
    -   ``SwitchIssuDetailsByIpAddress``
            - ``refresh``
...
def test_switch_issu_details_by_ip_address_00130(issu_details_by_ip_address) -> None:
    """
    ### Classes and Methods
    -   ``SwitchIssuDetailsByIpAddress``
            - ``refresh``
    ...
    match = r"SwitchIssuDetailsByIpAddress\.refresh_super:\s+"
...
def test_switch_issu_details_by_ip_address_00140(issu_details_by_ip_address) -> None:
    """
    ### Classes and Methods
    -   ``SwitchIssuDetailsByIpAddress``
            - ``refresh``
...
def test_switch_issu_details_by_ip_address_00150(issu_details_by_ip_address) -> None:
    """
    ### Classes and Methods
    -   ``SwitchIssuDetailsByIpAddress``
            - ``refresh``
...
def test_switch_issu_details_by_ip_address_00200(issu_details_by_ip_address) -> None:
    """
    ### Classes and Methods
    -   ``SwitchIssuDetailsByIpAddress``
            - ``_get``
    ...
    ### Description
    ``SwitchIssuDetailsByIpAddress._get`` is called by all getter
    ...
    match = r"SwitchIssuDetailsByIpAddress\._get:\s+"
    match += r"1\.1\.1\.1 does not exist on the controller\."
    with pytest.raises(ValueError, match=match):
        instance._get("serialNumber")


def test_switch_issu_details_by_ip_address_00210(
        issu_details_by_ip_address
) -> None:
    """
    ### Classes and Methods
    ...
    ### Description
    See test_switch_issu_details_by_ip_address_00200.
    """
    method_name = inspect.stack()[0][3]
    key = f"{method_name}a"
    ...
    match = r"SwitchIssuDetailsByIpAddress\._get:\s+"
    match += r"172\.22\.150\.102 unknown property name: FOO\."

    with pytest.raises(ValueError, match=match):
        instance._get("FOO")


def test_switch_issu_details_by_ip_address_00220(
    issu_details_by_ip_address,
) -> None:
    """
    ### Classes and Methods
