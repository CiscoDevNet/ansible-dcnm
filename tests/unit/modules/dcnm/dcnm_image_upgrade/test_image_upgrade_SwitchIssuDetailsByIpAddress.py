...
def test_image_mgmt_switch_issu_details_by_ip_address_00001(issu_details) -> None:
    """
    Function
    - __init__
...
def test_image_mgmt_switch_issu_details_by_ip_address_00002(issu_details) -> None:
    """
    Function
    - _init_properties
    ...
    assert issu_details.properties.get("ip_address") == None
...
def test_image_mgmt_switch_issu_details_by_ip_address_00021(
    ...
    issu_details.refresh()
    issu_details.ip_address = "172.22.150.102"
    ...
    issu_details.ip_address = "172.22.150.108"
...
def test_image_mgmt_switch_issu_details_by_ip_address_00040(
    ...
    issu_details.refresh()
    issu_details.ip_address = "1.1.1.1"
