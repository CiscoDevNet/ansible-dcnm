        ...
        if not is_replaced_multisite_child:
            ...
            if cfg.get("dhcp_servers", None) is None:
                ...
                if cfg.get("dhcp_srvr1_ip", None) is not None:
                    want_dhcp_servers[0] = dict(srvrAddr=cfg.get("dhcp_srvr1_ip"), srvrVrf=cfg.get("dhcp_srvr1_vrf"))
                ...
                if cfg.get("dhcp_srvr2_ip", None) is not None:
                    want_dhcp_servers[1] = dict(srvrAddr=cfg.get("dhcp_srvr2_ip"), srvrVrf=cfg.get("dhcp_srvr2_vrf"))
                ...
                if cfg.get("dhcp_srvr3_ip", None) is not None:
                    want_dhcp_servers[2] = dict(srvrAddr=cfg.get("dhcp_srvr3_ip"), srvrVrf=cfg.get("dhcp_srvr3_vrf"))
