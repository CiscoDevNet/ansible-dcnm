    ...
    def update_create_params(self, net):
        ...
        if template_conf["dhcpServers"] == []:
            ...
            if template_conf["dhcpServerAddr1"] != "":
                dhcp_srvr_list.append({"srvrAddr": template_conf["dhcpServerAddr1"], "srvrVrf": template_conf.get("vrfDhcp")})
            if template_conf["dhcpServerAddr2"] != "":
                dhcp_srvr_list.append({"srvrAddr": template_conf["dhcpServerAddr2"], "srvrVrf": template_conf.get("vrfDhcp2")})
            if template_conf["dhcpServerAddr3"] != "":
                dhcp_srvr_list.append({"srvrAddr": template_conf["dhcpServerAddr3"], "srvrVrf": template_conf.get("vrfDhcp3")})
            if dhcp_srvr_list != []:
