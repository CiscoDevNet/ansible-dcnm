...
class DcnmIntf:
    ...
    def dcnm_intf_get_vpc_serial_number(self, sw):
        ...
        path = (
            "/rest/interface/vpcpair_serial_number?serial_number="
            + self.ip_sn[sw]
        )
                                        ...
                                        for nk in nv_keys:
                                            ...
                                            for index in range(len(d[k])):
                                                ...
                                                if res == "dont_add":
                                                    break
                                            if res == "copy_and_add":
                                                want[k][0][ik][nk] = d[k][0][
                                                    ik
                                                ][nk]
                                                changed_dict[k][0][ik][nk] = d[
                                                    k
                                                ][0][ik][nk]
                                            if res != "dont_add":
                                                action = "update"
    ...
    def dcnm_intf_get_diff_query(self):
        ...
        for info in self.intf_info:
            ...
            if info["name"] == "":
                ...
                path = (
                    "/rest/interface?serialNumber=" + sno + "&ifName=" + ifname
                )
    ...
    def dcnm_parse_response(self, resp):
        ...
        for ent in entities:
            if ent_resp[ent] == "No Error":
                ...
                (ent_resp[ent] == "No Commands to execute.")
    ...
    def dcnm_intf_send_message_to_dcnm(self):
        ...
        for delem in self.diff_delete:
            ...
            if (resp.get("MESSAGE") != "OK") or (
                ...
                if (
                    (resp.get("MESSAGE") != "OK")
                    and (resp.get("MESSAGE") != "No Commands to execute.")
