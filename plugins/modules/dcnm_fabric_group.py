...
class Merged(Common):
    ...
    def send_need_create(self) -> None:
        ...
        self.fabric_group_create.fabric_details = self.fabric_details
    ...
    def send_need_update(self) -> None:
        ...
        self.fabric_group_update.fabric_details = self.fabric_details
...
class Query(Common):
    ...
    def commit(self) -> None:
        ...
        fabric_group_query.fabric_details = self.fabric_details
...
class Replaced(Common):
    ...
    def send_need_replaced(self) -> None:
        ...
        self.fabric_group_replaced.fabric_details = self.fabric_details
...
def main():
    ...
    try:
        task: Union[Deleted, Merged, Query, Replaced]
