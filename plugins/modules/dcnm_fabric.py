    ...
    suboptions:
      ...
      VXLAN_EVPN_FABRIC_PARAMETERS:
        ...
        suboptions:
            ...
            description:
                - Route Map used to redistribute BGP routes to IGP in default vrf in
                auto created VRF Lite IFC links
            ...
            description:
                ...
                devices in Easy Fabric and edge routers in External Fabric. The IP
                address is taken from the VRF Lite Subnet IP Range pool.
      ...
      VXLAN_EVPN_FABRIC_MSD_PARAMETERS:
        ...
        suboptions:
            ...
            description:
                ...
                functionality is being deprecated for MSD fabrics. Recommendation
                is to use NDFC Backup & Restore"
            ndfc_gui_label: Scheduled Fabric Backup
            ndfc_gui_section: Configuration Backup
            required: false
            type: bool
