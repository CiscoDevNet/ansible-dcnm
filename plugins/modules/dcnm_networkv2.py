...
# Example for creating a network using a Default_Network_Universal/Extension templates
# and Custom_Network_Universal/Extension templates
- name: Merge networks
  cisco.dcnm.dcnm_networkv2:
    ...
    config:
      - net_name: "net1"
        ...
        # network_template_config block uses the config params and
        # values specified in template specifed net_template
        # User should know the config params and values specified in the template.
        network_template_config:
      ...
      - net_name: "net2"
        ...
        net_extension_template: Custom_Network_Extension_Universal
        network_template_config:
          gatewayIpAddress: "4.10.1.1/24"
          intfDescription: "testnet_interface"
          mtu: 1500
          secondaryGW1: "30.11.1.1"
          loopbackId: 10
          attach:
            - ipAddress: "2.2.2.2"
              attached: true
              vlan: 200
              switchPorts: ["Ethernet1/10","Ethernett1/12"]
              torPorts:
                - switch: Tor4
        ...
        network_template_config:
          ...
          attach:
            - ipAddress: "1.1.1.1"
              ...
              vlan: 100
              # switchPorts: ["Ethernet1/1","Ethernett1/2"]
              # Replace the exiting switchPorts with the new switchPorts in attach
              switchPorts: ["Ethernet1/21", "Ethernet1/22", "Ethernet1/23"]
              torPorts:
                - switch: Tor1
                  ports: ["Ethernet1/13","Ethernet1/14"]
              deploy: true
        # This network will not be touched if already present
      - net_name: "net2"
        vrf_name: "vrf2"
        net_id: 200
        vlan_id: 200
      ...
      - net_name: "net1"
        ...
        network_template_config:
          ...
          attach:
            ...
            #       ports: ["Ethernet1/13","Ethernet1/14"]
            #   deploy: true
            # Existing network attachment above will be deleted and new attachment below will be added
            - ipAddress: "2.2.2.2"
              attached: true
              vlan: 200
              switchPorts: ["Ethernet1/10","Ethernett1/12"]
              torPorts:
                - switch: Tor4
                  ports: ["Ethernet1/3","Ethernet1/4"]
              deploy: true
            # Any existing networks in NDFC, not mentioned in the playbook will be deleted
