...
"""
Common methods used by the other classes supporting the dcnm_fabric module.
"""
...
class FabricCommon:
    ...
    def _init_key_translations(self):
        ...
        self._key_translations["DEFAULT_QUEUING_POLICY_CLOUDSCALE"] = "DEAFULT_QUEUING_POLICY_CLOUDSCALE"
        self._key_translations["DEFAULT_QUEUING_POLICY_OTHER"] = "DEAFULT_QUEUING_POLICY_OTHER"
        self._key_translations["DEFAULT_QUEUING_POLICY_R_SERIES"] = "DEAFULT_QUEUING_POLICY_R_SERIES"
