...
try:
    ...
    from ..common.third_party.pydantic import BaseModel, ConfigDict, Field, field_serializer, field_validator
    HAS_PYDANTIC = False
...
class PayloadVrfsAttachmentsLanAttachListExtensionValues(BaseModel):
    ...
    @classmethod
    def preprocess_multisite_conn(cls, value: str | dict) -> Optional[PayloadVrfsAttachmentsLanAttachListExtensionValuesMultisiteConn]:
        """
...
class PayloadVrfsAttachmentsLanAttachListItem(BaseModel):
    ...
    @classmethod
    def preprocess_extension_values(cls, value: str | dict) -> PayloadVrfsAttachmentsLanAttachListExtensionValues:
        """
        # Summary
