...
class Version:
    ...
    def commit(self):
        ...
        msg = f"Version = {self.dcnm_version}\n"
        self.log.debug(msg)
...
class FabricInfo:
    ...
    def commit(self):
        ...
        for fabric in processed_fabrics:
            ...
            msg = f"Fabric Access Mode Resp = {resp}\n"
            self.log.debug(msg)
...
class SwitchInfo:
    ...
    def dcnm_update_switch_mapping_info(self):
        ...
        msg = f"IP_SN = {self.ip_sn}\n"
        self.log.debug(msg)
        msg = f"SN_HN = {self.sn_hn}\n"
        self.log.debug(msg)
        msg = f"SN_IP = {self.sn_ip}\n"
        self.log.debug(msg)
    ...
    def dcnm_update_switch_managability_info(self):
        ...
        msg = f"Meta Switches = {self.meta_switches}\n"
        self.log.debug(msg)
        msg = f"Managable Switches = {self.managable}\n"
        self.log.debug(msg)
