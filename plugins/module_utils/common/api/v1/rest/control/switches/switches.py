...
from ansible_collections.cisco.dcnm.plugins.module_utils.common.api.v1.rest.control.control import \
    Control


class Switches(Control):
    """
    ## V1 API Switches() - api.v1.rest.control.switches.Switches()
    ...
    def __init__(self):
        ...
        msg = f"ENTERED api.v1.rest.control.switches.{self.class_name}"
        self.log.debug(msg)
...
class EpFabricSummary(Switches):
    """
    ## V1 API - api.v1.rest.control.switches.EpFabricSummary()
